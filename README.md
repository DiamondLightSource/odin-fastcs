...
5. Prepare the dev environment (in the root of odin-fastcs)
...
6. Run the dev environment (in the root of odin-fastcs)

    i. `$ dev/start.sh`

7. `> Debug: Select and Start Debugging` and select `Odin IOC` to run the IOC

UIs will be generated in the rooy of odin-fastcs that can be opened in Phoebus. This is
